...
var snowStorm = (function(window, document) {
  ...
  this.flakesMax = 800;           // Limit total amount of snow made (falling + sticking)
  ...
  this.targetElement = document.getElementsByClassName('left-nav-container')[0];      // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
